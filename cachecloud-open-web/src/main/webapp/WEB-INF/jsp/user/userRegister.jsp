							...
							<div class="form">
									...
									<form action="/user/apply.do" method="post"
										...
										<div class="form-body">
											...
											<div class="form-actions fluid" style="margin-top: 30px;">
												<div class="row">
													<div class="col-md-12">
														<div class="col-md-offset-3 col-md-5">
															...
															<div class="col-md-4">
																<input class="btn green" type="button" value="&nbsp;&nbsp;返&nbsp;&nbsp;&nbsp;回&nbsp;&nbsp;" onClick="location.href='/manage/login'">
															</div>
														</div>
													</div>
												</div>
